...
import 'education_videos_model.dart';
export 'education_videos_model.dart';

class EducationVideosWidget extends StatefulWidget {
  const EducationVideosWidget({super.key});

  @override
  State<EducationVideosWidget> createState() => _EducationVideosWidgetState();
}

class _EducationVideosWidgetState extends State<EducationVideosWidget> {
  late EducationVideosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EducationVideosModel());
