...
import 'food_videos_model.dart';
export 'food_videos_model.dart';

class FoodVideosWidget extends StatefulWidget {
  const FoodVideosWidget({super.key});

  @override
  State<FoodVideosWidget> createState() => _FoodVideosWidgetState();
}

class _FoodVideosWidgetState extends State<FoodVideosWidget> {
  late FoodVideosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FoodVideosModel());
