...
import 'health_care_videos_model.dart';
export 'health_care_videos_model.dart';

class HealthCareVideosWidget extends StatefulWidget {
  const HealthCareVideosWidget({super.key});

  @override
  State<HealthCareVideosWidget> createState() => _HealthCareVideosWidgetState();
}

class _HealthCareVideosWidgetState extends State<HealthCareVideosWidget> {
  late HealthCareVideosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HealthCareVideosModel());
