...
import 'technology_videos_model.dart';
export 'technology_videos_model.dart';

class TechnologyVideosWidget extends StatefulWidget {
  const TechnologyVideosWidget({super.key});

  @override
  State<TechnologyVideosWidget> createState() => _TechnologyVideosWidgetState();
}

class _TechnologyVideosWidgetState extends State<TechnologyVideosWidget> {
  late TechnologyVideosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TechnologyVideosModel());
