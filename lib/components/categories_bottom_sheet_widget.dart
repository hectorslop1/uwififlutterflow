...
class CategoriesBottomSheetWidget extends StatefulWidget {
  const CategoriesBottomSheetWidget({super.key});

  @override
  State<CategoriesBottomSheetWidget> createState() =>
                                ...
                                Container(
                                  ...
                                  child: FutureBuilder<ApiCallResponse>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final columnHealthcareResponse =
                                          snapshot.data!;
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          context.pushNamed('HealthCareVideo');
                                        },
                                        child: Column(
                                          mainAxisSize: MainAxisSize.max,
                                          mainAxisAlignment:
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    image: DecorationImage(
                                      fit: BoxFit.cover,
                                      image: Image.network(
                                        'https://images.unsplash.com/photo-1491841550275-ad7854e35ca6?q=80&w=4514&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
                                      ).image,
                                    ),
                                    gradient: const LinearGradient(
                                      colors: [
                                  ...
                                  child: InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      context.pushNamed('EducationVideo');
                                    },
                                    child: Column(
                                      mainAxisSize: MainAxisSize.max,
                                      mainAxisAlignment: MainAxisAlignment.end,
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: InkWell(
                                      ...
                                      highlightColor: Colors.transparent,
                                      onTap: () async {
                                        context.pushNamed('TechnologyVideo');
                                      },
                                      child: Column(
                                        mainAxisSize: MainAxisSize.max,
                                        mainAxisAlignment:
