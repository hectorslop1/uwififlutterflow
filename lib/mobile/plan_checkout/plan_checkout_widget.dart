...
import 'plan_checkout_model.dart';
export 'plan_checkout_model.dart';

class PlanCheckoutWidget extends StatefulWidget {
  const PlanCheckoutWidget({super.key});

  @override
  State<PlanCheckoutWidget> createState() => _PlanCheckoutWidgetState();
}

class _PlanCheckoutWidgetState extends State<PlanCheckoutWidget>
    with TickerProviderStateMixin {
  late PlanCheckoutModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlanCheckoutModel());
