...
import 'gadget_product_model.dart';
export 'gadget_product_model.dart';

class GadgetProductWidget extends StatefulWidget {
  const GadgetProductWidget({super.key});

  @override
  State<GadgetProductWidget> createState() => _GadgetProductWidgetState();
}

class _GadgetProductWidgetState extends State<GadgetProductWidget>
    with TickerProviderStateMixin {
  late GadgetProductModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GadgetProductModel());
