...
import 'network_page_mobile_model.dart';
export 'network_page_mobile_model.dart';

class NetworkPageMobileWidget extends StatefulWidget {
  const NetworkPageMobileWidget({super.key});

  @override
  State<NetworkPageMobileWidget> createState() =>
      _NetworkPageMobileWidgetState();
}

class _NetworkPageMobileWidgetState extends State<NetworkPageMobileWidget> {
  late NetworkPageMobileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NetworkPageMobileModel());
