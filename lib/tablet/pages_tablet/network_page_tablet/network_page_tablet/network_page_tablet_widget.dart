...
import 'network_page_tablet_model.dart';
export 'network_page_tablet_model.dart';

class NetworkPageTabletWidget extends StatefulWidget {
  const NetworkPageTabletWidget({super.key});

  @override
  State<NetworkPageTabletWidget> createState() =>
      _NetworkPageTabletWidgetState();
}

class _NetworkPageTabletWidgetState extends State<NetworkPageTabletWidget> {
  late NetworkPageTabletModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NetworkPageTabletModel());
            ...
            child: Column(
              ...
              children: [
                ...
                Align(
                  ...
                  child: Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(0.0, 15.0, 0.0, 140.0),
                    child: FFButtonWidget(
                      onPressed: () async {
