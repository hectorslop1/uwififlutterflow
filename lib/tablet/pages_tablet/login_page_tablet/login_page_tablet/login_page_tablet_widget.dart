...
import '/mobile/widgets/reset_password/reset_password_widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter_animate/flutter_animate.dart';
import 'login_page_tablet_model.dart';
export 'login_page_tablet_model.dart';

class LoginPageTabletWidget extends StatefulWidget {
  const LoginPageTabletWidget({super.key});

  @override
  State<LoginPageTabletWidget> createState() => _LoginPageTabletWidgetState();
}

class _LoginPageTabletWidgetState extends State<LoginPageTabletWidget>
    with TickerProviderStateMixin {
  late LoginPageTabletModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginPageTabletModel());
