...
import 'home_tablet_model.dart';
export 'home_tablet_model.dart';

class HomeTabletWidget extends StatefulWidget {
  const HomeTabletWidget({super.key});

  @override
  State<HomeTabletWidget> createState() => _HomeTabletWidgetState();
}

class _HomeTabletWidgetState extends State<HomeTabletWidget> {
  late HomeTabletModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeTabletModel());
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                                                        ...
                                                        child: SizedBox(
                                                          height:
                                                              MediaQuery.sizeOf(
                                                                  ...
                                                                  1.0,
                                                          child:
                                                              const AboutConnectionQualityWidget(),
                                                        ),
                                                      );
                                                    },
                                                  ).then((value) =>
                ...
                Padding(
                  padding:
                      const EdgeInsetsDirectional.fromSTEB(0.0, 20.0, 0.0, 150.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
          ...
          child: Column(
            ...
            children: [
              Flexible(
                child: Padding(
                  padding:
                      const EdgeInsetsDirectional.fromSTEB(40.0, 0.0, 40.0, 44.0),
                  child: Material(
                    color: Colors.transparent,
                    elevation: 20.0,
