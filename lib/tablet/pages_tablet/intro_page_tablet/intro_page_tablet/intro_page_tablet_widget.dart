...
import 'intro_page_tablet_model.dart';
export 'intro_page_tablet_model.dart';

class IntroPageTabletWidget extends StatefulWidget {
  const IntroPageTabletWidget({super.key});

  @override
  State<IntroPageTabletWidget> createState() => _IntroPageTabletWidgetState();
}

class _IntroPageTabletWidgetState extends State<IntroPageTabletWidget>
    with TickerProviderStateMixin {
  late IntroPageTabletModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IntroPageTabletModel());
