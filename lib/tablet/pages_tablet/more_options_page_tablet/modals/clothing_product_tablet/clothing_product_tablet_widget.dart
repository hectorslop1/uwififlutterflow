...
import 'clothing_product_tablet_model.dart';
export 'clothing_product_tablet_model.dart';

class ClothingProductTabletWidget extends StatefulWidget {
  const ClothingProductTabletWidget({super.key});

  @override
  State<ClothingProductTabletWidget> createState() =>
      _ClothingProductTabletWidgetState();
}

class _ClothingProductTabletWidgetState
    extends State<ClothingProductTabletWidget> {
  late ClothingProductTabletModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClothingProductTabletModel());
