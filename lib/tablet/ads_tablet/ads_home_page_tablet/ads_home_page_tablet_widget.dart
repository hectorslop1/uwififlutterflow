...
import 'ads_home_page_tablet_model.dart';
export 'ads_home_page_tablet_model.dart';

class AdsHomePageTabletWidget extends StatefulWidget {
  const AdsHomePageTabletWidget({super.key});

  @override
  State<AdsHomePageTabletWidget> createState() =>
      _AdsHomePageTabletWidgetState();
}

class _AdsHomePageTabletWidgetState extends State<AdsHomePageTabletWidget>
    with TickerProviderStateMixin {
  late AdsHomePageTabletModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdsHomePageTabletModel());
                              ...
                              return InkWell(
                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    Align(
                                      alignment:
                                          const AlignmentDirectional(0.0, 1.51),
                                      child: Container(
                                        width: double.infinity,
                                        height: 200.0,
                                        decoration: BoxDecoration(
            ...
            Container(
              ...
              child: FutureBuilder<ApiCallResponse>(
                ...
                builder: (context, snapshot) {
                  ...
                  return Builder(
                    builder: (context) {
                      final registrosList = rowRegistrosResponse.jsonBody
                          .toList()
                          .take(8)
                          .toList();
            ...
            Container(
              ...
              child: FutureBuilder<ApiCallResponse>(
                ...
                builder: (context, snapshot) {
                  ...
                  return Builder(
                    builder: (context) {
                      final educationList = rowEducationResponse.jsonBody
                          .toList()
                          .take(8)
                          .toList();
                      return SingleChildScrollView(
