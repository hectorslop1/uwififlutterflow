...
import 'products_checkout_tablet_model.dart';
export 'products_checkout_tablet_model.dart';

class ProductsCheckoutTabletWidget extends StatefulWidget {
  const ProductsCheckoutTabletWidget({super.key});

  @override
  State<ProductsCheckoutTabletWidget> createState() =>
      _ProductsCheckoutTabletWidgetState();
}

class _ProductsCheckoutTabletWidgetState
    extends State<ProductsCheckoutTabletWidget> {
  late ProductsCheckoutTabletModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductsCheckoutTabletModel());
