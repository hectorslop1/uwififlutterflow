...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF029D30);
  late Color secondary = const Color(0xFF6A2FC5);
  late Color tertiary = const Color(0xFF5B5B5B);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFBCBCBC);
  ...
  late Color tarjetas = const Color(0xFFDBDBDB);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF05C738);
  late Color secondary = const Color(0xFF7C47DD);
  late Color tertiary = const Color(0xFF7D7D7D);
  late Color alternate = const Color(0xFF262D34);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF95A1AC);
  late Color primaryBackground = const Color(0xFF1D2428);
  late Color secondaryBackground = const Color(0xFF14181B);
  late Color accent1 = const Color(0xFF3B3B3B);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  ...
  late Color tarjetas = const Color(0xFF252B31);
  late Color overlay = const Color(0xB31D2428);
