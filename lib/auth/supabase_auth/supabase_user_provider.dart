...
class UWifiSupabaseUser extends BaseAuthUser {
  UWifiSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> uWifiSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = UWifiSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
